defmodule Day10.AsteroidsTest do
  ...
  test "it counts vaporized asteroids" do
    map = ".#..##.###...#######\n##.############..##.\n.#.######.########.#\n.###.#######.####.#.\n#####.##.#.##.###.##\n..#####..#.#########\n####################\n#.####....###.#.#.##\n##.#################\n#####.##.###..####..\n..######..##.#######\n####.##.####...##..#\n.#####..#.######.###\n##...#.##########...\n#.##########.#######\n.####.#.###.###.#.##\n....##.##.###..#####\n.#.#.###########.###\n#.#.#.#####.####.###\n###.##.####.##.#..##" |> String.split("\n") |> Day10.Asteroids.parse
    assert Day10.Asteroids.vaporize(map, {11, 13}, 1) == {11, 12}
    assert Day10.Asteroids.vaporize(map, {11, 13}, 200) == {8, 2}
  end
  test "it orders coordinates correctly" do
    assert Day10.Asteroids.coords_of({1, 1}, {1, 0}) > Day10.Asteroids.coords_of({1, 1}, {2, 1})
    assert Day10.Asteroids.coords_of({1, 1}, {2, 1}) > Day10.Asteroids.coords_of({1, 1}, {1, 2})
    assert Day10.Asteroids.coords_of({1, 1}, {1, 2}) > Day10.Asteroids.coords_of({1, 1}, {0, 1})
  end
end
