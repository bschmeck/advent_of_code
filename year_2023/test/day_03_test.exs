defmodule Day03Test do
  ...
  test "it can sum gear ratios" do
    assert Day03.part_two(InputTestFile) == 467835
  end
  ...
  test "it updates existing totals" do
    assert %{{3, 0} => [467, 2], {0, 1} => [467], {1, 1} => [467], {2, 1} => [467], {3, 1} => [467]} = Day03.populate(%{{3, 0} => [2]}, {467, [2, 1, 0]}, 0)
  end
end
