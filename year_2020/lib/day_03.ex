defmodule Day03 do
  ...
  defp count([line | rest], total, index, {_right, 1} = slope), do: count(line, rest, total, index, slope)
  defp count([line | [_skip | rest]], total, index, {_right, 2} = slope), do: count(line, rest, total, index, slope)
