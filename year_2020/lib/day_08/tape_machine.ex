defmodule Day08.TapeMachine do
  ...
  def new([instruction | rest]),
    do: %__MODULE__{prev: [], next: rest, current: instruction, accum: 0}
  ...
  def advance(%__MODULE__{next: []} = machine, 1),
    do: %__MODULE__{machine | prev: [machine.current | machine.prev], current: :done}
