defmodule Day17.PocketDimensionTest do
  ...
  test "it expands properly" do
    cycle_0 = %Day17.PocketDimension{grid: [{1, 0, 0}, {2, 1, 0}, {0, 2, 0}, {1, 2, 0}, {2, 2, 0}]}
    cycle_1 = Day17.PocketDimension.simulate(cycle_0)
    assert Enum.sort(cycle_1.grid) == Enum.sort([{0,1,0},{2,1,0},{1,2,0},{2,2,0},{1,3,0},{0,1,-1},{2,2,-1},{1,3,-1},{0,1,1},{2,2,1},{1,3,1}])
  end
